...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative mx-auto flex w-full max-w-4xl flex-col items-center px-6 pt-24 text-center"
        lang={lang}
      >
        <p
          className={`text-sm tracking-[0.2em] text-cyan-soft animate-fade-in-up ${ethiopic}`}
        >
          {t.hero.eyebrow}
        </p>
        ...
        >
          <span
            className={`block text-white drop-shadow-[0_4px_20px_rgba(0,0,0,0.65)] ${ethiopic} !leading-[1.2]`}
          >
            {t.hero.headline}
          </span>
        </h1>
        ...
        >
          <span
            className={`inline-block rounded-full bg-ink-soft/70 border border-white/10 px-4 py-1 text-xs uppercase tracking-[0.25em] text-white/80 ${ethiopic}`}
          >
            {t.hero.tagline}
          </span>
        </div>
        ...
        >
          ...
          <a
            ...
            className={`w-full rounded-full bg-orange px-9 py-4 text-sm font-bold uppercase tracking-wider text-white transition-all duration-300 hover:scale-105 sm:w-auto ${ethiopic}`}
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`w-full rounded-full border border-white/20 bg-white/5 px-9 py-4 text-sm font-bold uppercase tracking-wider text-white/85 transition-all duration-300 hover:border-white/30 hover:bg-white/10 hover:text-white hover:scale-105 sm:w-auto ${ethiopic}`}
          >
            {t.hero.cta2}
          </a>
        </div>
