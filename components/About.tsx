...
export default function About() {
  ...
  return (
    <>
      ...
      >
        <div
          className="mx-auto grid max-w-6xl gap-12 px-4 sm:px-6 md:grid-cols-2 md:items-center"
          lang={lang}
        >
          <Reveal>
            ...
            <h2
              className={`mt-5 font-display text-3xl uppercase text-ink sm:text-4xl md:text-5xl !leading-[1.25] ${ethiopic}`}
            >
              {t.about.title}
            </h2>
            <div className="mt-5 h-1 w-20 rounded-full bg-charcoal/15" />
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              ...
              <div className="rounded-2xl border border-cyan-deep/20 bg-white p-4 shadow-sm hover:border-cyan-deep/40 transition-colors">
                <p className="font-display text-2xl text-cyan-deep">
                  {t.about.stat2Value}
                </p>
                <p
                  className={`mt-1 text-xs uppercase tracking-wider text-charcoal/60 ${ethiopic}`}
          ...
          <Reveal delay={2}>
            <div className="relative mx-auto aspect-[4/5] w-full max-w-md overflow-hidden rounded-[2rem] border-2 border-orange/30 shadow-[0_20px_50px_rgba(242,128,30,0.2)]">
              ...
              <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between bg-ink/70 border border-white/20 p-4 rounded-2xl text-white">
                <div>
                  <p className="text-xs uppercase tracking-widest text-gold-soft font-semibold">
                    Location
                  </p>
                  <p className="text-sm font-medium">
                    Eliana Hotel, Piassa 2nd Floor
                  </p>
                </div>
