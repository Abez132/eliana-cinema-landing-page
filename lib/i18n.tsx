...
export const content = {
  ...
  am: {
    nav: { about: "ስለ እኛ", experience: "ተሞክሮው", tickets: "ትኬቶች", snacks: "የመክሰስ ባር", reviews: "አስተያየቶች", gallery: "ማዕከለ-ስዕላት", visit: "ይጎብኙን", book: "ትኬት ይያዙ" },
    hero: {
      eyebrow: "የፒያሳ አካባቢ የትልቁ ስክሪን መገኛ",
      headline: "ፍጹም የሲኒማ ቅጽበትን ይለማመዱ",
      sub: "ዶልቢ አትሞስ ድምጽ፣ የብር ስክሪን እና ምቹ ሪክላይነር ወንበሮች — የአዲስ አበባ ክላሲክ የፊልም ምሽት፣ በትክክለኛው መንገድ።",
      cta1: "ትኬት ይያዙ",
    ...
    experience: {
      ...
      items: [
        ...
        { title: "ምቹ ሪክላይነሮች", description: "ለሚገባቸው ትዕይንቶች ቪአይፒ ሪክላይነር መቀመጫዎች።" },
        { title: "የመክሰስ ባር", description: "ፖፕኮርን፣ ጥብስ፣ ትኩስ ጭማቂ እና አይስ ክሬም — ሁሉም በቦታው ላይ የሚዘጋጅ።" },
        { title: "በየሳምንቱ አዳዲስ ፊልሞች", description: "የአካባቢ ፕሮዳክሽኖች እና ዓለም አቀፍ ፊልሞች፣ በየሳምንቱ የሚቀያየሩ።" },
        { title: "ቀላል መዳረሻ", description: "በፒያሳ በቸርችል አቬኑ ላይ በቀጥታ — ጥሩ ስክሪን ለማግኘት ከተማውን መሻገር አያስፈልግም።" },
      ],
    },
    tickets: {
      eyebrow: "ትኬቶች",
      ...
      vip: {
        name: "ቪአይፒ",
        price: business.ticketVip,
        description: "ለሚገባቸው ትዕይንቶች ሙሉ ለሙሉ ዘና የሚሉበት ቪአይፒ ሪክላይነር መቀመጫ።",
      },
      cta: "በቴሌግራም ይያዙ",
    },
    snacks: {
      ...
      items: [
        ...
        { title: "ጥብስ", description: "ወርቃማ እና ጥርት ያለ፣ ከቲማቲም ሾርባ ጋር የሚቀርብ።" },
    ...
    reviews: {
      ...
      items: [
        ...
        { quote: "ቪአይፒ ምቹ ሪክላይነር መቀመጫዎች የተገጠመለት ነው።", author: "የእንግዳ አስተያየት" },
    ...
    gallery: {
      ...
      items: [
        ...
        { label: "ሪክላይነር መቀመጫ", image: "/images/photos/hall-seats-wide.jpg" },
